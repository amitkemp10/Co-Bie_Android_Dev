package com.example.co_bie.Event.MyEvent.Participate;
...
public class ParticipateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_participate, container, false);

        mRecyclerView = rootView.findViewById(R.id.rv_manage_events);
        myEventsList = new ArrayList<>();
        myEventAdapter = new MyEventAdapter(getContext(), myEventsList, 2);
